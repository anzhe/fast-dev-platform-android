...
public abstract class MyLoadMoreContainerBase extends LinearLayout implements MyLoadMoreContainer {

	private AbsListView.OnScrollListener mOnScrollListener;
	private MyLoadMoreUIHandler mLoadMoreUIHandler;
	private MyLoadMoreHandler mLoadMoreHandler;
	...
	public MyLoadMoreContainerBase(Context context) {
		super(context);
	}

	public MyLoadMoreContainerBase(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	...
	public void useDefaultFooter() {
		MyLoadMoreDefaultFooterView footerView = new MyLoadMoreDefaultFooterView(getContext());
	...
	public void loadMoreFinish(boolean emptyResult, boolean hasMore, boolean showLoadedFinishText) {
		...
		if (mLoadMoreUIHandler != null) {
			mLoadMoreUIHandler.onLoadFinish(this, emptyResult, hasMore, showLoadedFinishText);
		}
	}
