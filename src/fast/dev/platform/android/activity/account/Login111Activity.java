...
public class Login111Activity extends BaseActivity {

	private static final String TAG = Login111Activity.class.getSimpleName();
	...
	private NetworkChangeBroadcastReceiver networkChangeBroadcastReceiver = new NetworkChangeBroadcastReceiver(Login111Activity.class);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ThirdPartyUtils.addQZoneQQPlatform(Login111Activity.this);
