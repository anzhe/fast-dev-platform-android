package fast.dev.platform.android.fragment;
...
public class MainFragment extends BaseFragment {
	...
	private NetworkChangeBroadcastReceiver networkChangeBroadcastReceiver = new NetworkChangeBroadcastReceiver(MainFragment.class);
...
//		registerReceiver(networkChangeBroadcastReceiver, filter);
	...
	private void initViews(View root) {
		view1 = (LinearLayout) root.findViewById(R.id.tv_guid1);
		view2 = (LinearLayout) root.findViewById(R.id.tv_guid2);
		view3 = (LinearLayout) root.findViewById(R.id.tv_guid3);
		view4 = (LinearLayout) root.findViewById(R.id.tv_guid4);
		home_tv1 = (TextView) root.findViewById(R.id.home_tv1);
		home_tv2 = (TextView) root.findViewById(R.id.home_tv2);
		if (CommonUtils.isLawyer(user_sp)) {
			home_tv2.setText("服 务");
		} else {
			home_tv2.setText("热 门");
		}
		home_tv3 = (TextView) root.findViewById(R.id.home_tv3);
		home_tv4 = (TextView) root.findViewById(R.id.home_tv4);
		home_iv1 = (ImageView) root.findViewById(R.id.home_iv1);
		home_iv2 = (ImageView) root.findViewById(R.id.home_iv2);
		home_iv3 = (ImageView) root.findViewById(R.id.home_iv3);
		home_iv4 = (ImageView) root.findViewById(R.id.home_iv4);
...
//	}
	...
	private void switchPage(int index) {
		...
		getFragmentManager().beginTransaction().replace(R.id.main_container, currentFragment).commitAllowingStateLoss();
	}
