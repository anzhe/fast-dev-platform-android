...
public class OkHttpUploadRequest extends OkHttpPostRequest {
	...
	protected OkHttpUploadRequest(String url, Object tag, Map<String, String> params, Map<String, String> headers,
		...
		if (files != null) {
			...
			for (int i = 0; i < files.length; i++) {
				...
				builder.addPart(Headers.of("Content-Disposition",
						"form-data; name=\"" + fileKeyName + "\"; filename=\"" + fileName + "\""), fileBody);
			}
		}
